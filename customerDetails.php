<html>
	...
	$sql = "SELECT * FROM WORK_ORDER,CUSTOMER WHERE CUSTOMER.`W/o_number` = '$_POST[numberWO]' AND WORK_ORDER.`W/o_number` = '$_POST[numberWO]'";
	...
	<div class="details-text">
	    ...
	    if ($status == 'Open')
	    {
		echo "<form action='closeCustomer.php' method='post'>
